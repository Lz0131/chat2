...
import 'package:chatlinxs/views/onboarding_page/widgets/animated_bottom_container.dart';
import 'package:chatlinxs/views/onboarding_page/widgets/animated_onboarding_images.dart';
import 'package:chatlinxs/views/onboarding_page/widgets/lottie_animation_stack_widget.dart';
        ...
        return Stack(
          children: [
            ...
            AnimatedBottomContainer(
                ...
                onLeftArrowReset: () =>
                    provider.onLeftArrowReset(isKeyboardOpened),
                onSendOtpClicked: provider.onSendOtpClicked,
                onOtpSubmit: (model.User us) =>
                    provider.onOtpSubmit(us, context))
          ],
        );
      }),
    );

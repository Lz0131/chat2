...
import 'package:chatlinxs/models/document.dart';
import 'package:chatlinxs/models/message.dart';
import 'package:latlong2/latlong.dart';
import 'package:chatlinxs/models/upi_payment.dart';
import 'package:chatlinxs/models/user.dart';
import 'package:chatlinxs/provider/audio_provider.dart';
import 'package:chatlinxs/views/contact_page/contact_page.dart';
import 'package:chatlinxs/views/message_page/message_page.dart';
import 'package:chatlinxs/views/message_page/widgets/map_screen.dart';
  ...
  onMainMenuClicked(
    ...
    switch (key) {
      ...
      case "contact":
        ...
        sendMultipleMessages(selectedContacts! //poner ! es lo que puse
            .map((e) => Message(
                userSendingMessageUUID: LocalDB.user.uuid,
